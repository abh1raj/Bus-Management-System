...
public final class Admin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<a class=\"nav-item nav-link text-white mx-2\" href=\"AddS.jsp\" >Add Schedule</a>\n");
      out.write("\t\t<a class=\"nav-item nav-link text-white mx-2\" href=\"DelS.jsp\" >Delete Schedule</a>\n");
      out.write("\t\t<a class=\"nav-item nav-link text-white mx-2\" href=\"Update.html\" >Edit Schedule</a>\n");
      out.write("\t</div>\n");
      out.write("\n");
      ...
      out.write("                            <form action=\"ResDrop\">\n");
      out.write("\t\t\t\t<div class=\"card-header\">Drop Point</div>\n");
      out.write("\t\t\t\t<div class=\"card-body text-center\">\n");
      out.write("\t\t\t\t\t<div class=\"card-title\">Enter Drop Point:</div>\n");
      out.write("\t\t\t\t\t<div class=\"card-text \">\n");
      out.write("\t\t\t\t\t\t<p><input type=\"text\"  name=\"dp\" class=\"form-control w-75 mx-auto text-center\" placeholder=\"Drop Point\"></p>\n");
      ...
      out.write("\t\t<div class=\"col p-2\">\n");
      out.write("\t\t\t<div class=\"card \">\n");
      out.write("                            <form action=\"ResRoute\">\n");
      out.write("\t\t\t\t<div class=\"card-header\">Route</div>\n");
      out.write("\t\t\t\t<div class=\"card-body text-center align-items-center\">\n");
      out.write("\t\t\t\t\t<div class=\"card-title\">Enter Route Name:</div>\n");
      out.write("\t\t\t\t\t<div class=\"card-text\">\n");
      out.write("\t\t\t\t\t\t<p><input type=\"text\" name=\"route\" class=\"form-control  w-75 mx-auto text-center\" placeholder=\"Route Name\"></p>\n");
      out.write("\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-outline-dark\">Submit</button>\n");
      out.write("\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t</div>\n");
      out.write("                            </form>\n");
      ...
      out.write("            <div class=\"col p-2\">\n");
      out.write("\t\t\t<div class=\"card\" >\n");
      out.write("                            <form action=\"ResPick\">\n");
      out.write("\t\t\t\t<div class=\"card-header\">Pickup Point</div>\n");
      out.write("\t\t\t\t<div class=\"card-body text-center\">\n");
      out.write("\t\t\t\t\t<div class=\"card-title\">Enter Pickup Point:</div>\n");
      out.write("\t\t\t\t\t<div class=\"card-text \">\n");
      out.write("\t\t\t\t\t\t<p><input type=\"text\"  name=\"pp\" class=\"form-control w-75 mx-auto text-center\" placeholder=\"Pickup Point\"></p>\n");
      out.write("\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-outline-dark\">Submit</button>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("                            </form>    \n");
